    ...
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
        ...
        <div class="mb-8 sm:flex sm:justify-between sm:items-center">
            ...
            <div class="grid justify-start grid-flow-col gap-2 sm:auto-cols-max sm:justify-end">
                <a href="{{ route('courses.index') }}" class="text-white bg-slate-500 btn hover:bg-slate-600">
            ...
            <div class="p-6">
                <form action="{{ route('courses.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Category -->
                        <div>
                            <label class="block text-sm font-medium mb-1" for="category_id">Category <span class="text-rose-500">*</span></label>
                        ...
                        <!-- Instructor -->
                        <div>
                            <label class="block text-sm font-medium mb-1" for="instructor_id">Instructor <span class="text-rose-500">*</span></label>
                            <select id="instructor_id" class="form-select w-full" name="instructor_id" required>
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                ...
                                <input id="certificate_available" class="form-checkbox" type="checkbox" name="certificate_available" value="1" {{ old('certificate_available') ? 'checked' : '' }} />
                        ...
                        <div>
                            ...
                            <input id="preview_video" class="form-input w-full" type="url" name="preview_video" value="{{ old('preview_video') }}" />
                            @error('preview_video')
                                <div class="text-rose-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
